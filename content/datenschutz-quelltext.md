...
Ihre Daten werden zum einen dadurch erhoben, dass Sie uns diese mitteilen — etwa wenn Sie uns eine E-Mail schreiben.

Andere Daten werden beim Besuch der Website automatisch durch die Systeme unseres Hosting-Anbieters erfasst. Das sind vor allem technische Daten wie Internetbrowser, Betriebssystem oder Uhrzeit des Seitenaufrufs.

**Wofür nutzen wir Ihre Daten?**

Die automatisch erhobenen Daten dienen der fehlerfreien und sicheren Bereitstellung der Website. Daten, die Sie uns aktiv mitteilen, nutzen wir zur Bearbeitung Ihres Anliegens.

Diese Website verwendet keine Cookies, kein Tracking und keine Analysewerkzeuge. Eine Analyse Ihres Nutzungsverhaltens findet nicht statt.
...
Wenn Sie unsere Website aufrufen, erfasst Vercel technische Daten wie Ihre IP-Adresse, Browsertyp, Betriebssystem und Zeitstempel des Zugriffs in Server-Logfiles, um die Stabilität und Sicherheit der Website zu gewährleisten.

Die Verwendung von Vercel erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse an einer zuverlässigen und sicheren Bereitstellung unserer Website.

**Datenübermittlung in die USA**

Die Datenübertragung in die USA wird auf das EU-U.S. Data Privacy Framework (DPF) gestützt. Vercel ist nach dem DPF zertifiziert. Zusätzlich sind die Standardvertragsklauseln der EU-Kommission vereinbart. Weitere Informationen finden Sie in der Datenschutzerklärung von Vercel unter https://vercel.com/legal/privacy-policy.

**Auftragsverarbeitung**

Wir haben mit Vercel einen Vertrag über Auftragsverarbeitung geschlossen. Hierbei handelt es sich um einen datenschutzrechtlich vorgeschriebenen Vertrag, der gewährleistet, dass Vercel die personenbezogenen Daten unserer Websitebesucher nur nach unseren Weisungen und unter Einhaltung der DSGVO verarbeitet.
...
E-Mail: lukas@projekt-tiefstart.de
...
Sofern Sie in die Datenverarbeitung eingewilligt haben, verarbeiten wir Ihre personenbezogenen Daten auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO beziehungsweise Art. 9 Abs. 2 lit. a DSGVO, sofern besondere Kategorien personenbezogener Daten nach Art. 9 Abs. 1 DSGVO verarbeitet werden. Im Falle einer ausdrücklichen Einwilligung in die Übertragung personenbezogener Daten in Drittstaaten erfolgt die Datenverarbeitung außerdem auf Grundlage von Art. 49 Abs. 1 lit. a DSGVO. Die Einwilligung ist jederzeit widerrufbar.
...
Diese Website setzt keine Cookies. Es werden keine Informationen in Ihrem Endgerät gespeichert oder ausgelesen. Es findet keine Reichweitenmessung, keine Webanalyse und kein Profiling statt. Eine Einwilligung nach § 25 Abs. 1 TDDDG ist daher nicht erforderlich; aus demselben Grund gibt es auf dieser Website kein Einwilligungsbanner.

### Lokal gehostete Schriften

Die auf dieser Website verwendeten Schriftarten werden lokal von unserem Server ausgeliefert. Eine Verbindung zu Servern Dritter, etwa zu Google Fonts, findet nicht statt. Ihre IP-Adresse wird zu diesem Zweck nicht an Dritte übermittelt.

### Server-Logfiles

Beim Aufruf dieser Website werden durch unseren Hosting-Anbieter automatisch Informationen in Server-Logfiles erfasst, die Ihr Browser übermittelt. Dies sind:
...
Die von Ihnen an uns übersandten Daten verbleiben bei uns, bis Sie uns zur Löschung auffordern, Ihre Einwilligung zur Speicherung widerrufen oder der Zweck für die Datenspeicherung entfällt, etwa nach abgeschlossener Bearbeitung Ihres Anliegens. Zwingende gesetzliche Bestimmungen, insbesondere gesetzliche Aufbewahrungsfristen, bleiben unberührt.

## 5. Verlinkte Angebote Dritter

Diese Website enthält Links zu Angeboten Dritter. Beim bloßen Aufruf unserer Website werden keine Daten an diese Anbieter übermittelt. Eine Übermittlung findet erst statt, wenn Sie einen solchen Link aktiv anklicken und die Seite des jeweiligen Anbieters aufrufen. Ab diesem Zeitpunkt gilt die Datenschutzerklärung des jeweiligen Anbieters.

### Terminbuchung über TidyCal

Für die Vereinbarung eines Erstgesprächs verlinken wir auf den Dienst TidyCal. Anbieter ist die AppSumo LLC, 1305 E 6th St, Austin, TX 78702, USA.

Wenn Sie diesen Link anklicken, verlassen Sie unsere Website. Die von Ihnen dort eingegebenen Daten – insbesondere Name, E-Mail-Adresse und der gewünschte Termin – werden von TidyCal verarbeitet und an uns übermittelt, damit wir den Termin durchführen können. Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO (Durchführung vorvertraglicher Maßnahmen).

Die Verarbeitung findet auch in den USA statt. Weitere Informationen zum Umgang mit Nutzerdaten finden Sie in der Datenschutzerklärung von TidyCal unter https://tidycal.com/privacy.

Wenn Sie diesen Weg nicht nutzen möchten, können Sie uns stattdessen jederzeit per E-Mail schreiben.
